-- ============================================================================
-- VISTAS DE OPTIMIZACIÓN - Arquitectura Híbrida
-- Ejecutar en SQL Editor de Supabase
-- ============================================================================

-- ============================================================================
-- VISTA 1: Convocatoria del Mes Activo
-- Reduce ~3600 registros → ~300 (solo mes actual)
-- ============================================================================
...
-- Verificar
-- SELECT COUNT(*) FROM vista_convocatoria_mes_activo;

-- ============================================================================
-- VISTA 2: Convocatoria Filtrable por Año/Mes
-- Similar a vista_convocatoria_mes_activo pero recibe parámetros via RPC
-- Para uso general cuando el usuario necesita otro mes
-- ============================================================================
...
-- Uso: SELECT * FROM vista_convocatoria_completa WHERE anio = 2025 AND mes = 7;

-- ============================================================================
-- VISTA 3: Dashboard KPIs Pre-calculados
-- Evita cálculos pesados en GAS
-- ============================================================================
...
SELECT 
    ...
    COUNT(DISTINCT c.id_convocatoria) FILTER (
        WHERE c.estado IN ('cumplida', 'vigente') 
        AND (c.turno_cancelado IS NULL OR c.turno_cancelado = false)
    ) AS turnos_cubiertos,
...
-- Uso: SELECT * FROM vista_dashboard_kpis WHERE anio = 2025;

-- ============================================================================
-- VISTA 4: Saldos en Vivo (ya existe, verificar/actualizar)
-- Usa turno_cancelado para excluir cancelados
-- ============================================================================
...
-- Uso: SELECT * FROM vista_saldo_horas_resumen WHERE anio = 2025 AND mes = 7;

-- ============================================================================
-- VISTA 5: Planificación del Año (para caché anual)
-- ============================================================================
...
-- Uso: SELECT * FROM vista_planificacion_anio WHERE anio = 2025;
