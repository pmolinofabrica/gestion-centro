-- ============================================================================
-- MIGRACIÓN: Permitir id_turno NULL en convocatoria
-- Objetivo: Soportar descansos sin turno asociado (modelo híbrido)
-- Fecha: 2025-12-11
-- ============================================================================
...
-- ============================================================================
-- PASO 1: Crear tabla temporal con schema correcto
-- ============================================================================
...
CREATE TABLE convocatoria_new (
    ...
    id_turno INTEGER,  -- ← CAMBIADO: Ahora permite NULL
...
-- ============================================================================
-- PASO 6: Actualizar trigger de descansos
-- ============================================================================
